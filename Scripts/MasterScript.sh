...
WORK_DIR="~/X"
PR_DIR="${WORK_DIR}/Project1/data1_2"

ImmPhen_DataDir="${WORK_DIR}/MIP_test/Data/Pheno/ImmPhen"
ImmPhen_DIR="${WORK_DIR}/MIP_test"
DATA_DIR="${WORK_DIR}/BP_test/Data"

#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# 1. Prepare MIP phenotypes
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

### Phenotype data has been provided by the Milieu Iterieur project, the file is called LabExMI_rawfacs.txt and stored in $ImmPhen_DataDir (see above)
...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# 10. Perform conditional analyses on secondary trait (gene expression traits)
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
