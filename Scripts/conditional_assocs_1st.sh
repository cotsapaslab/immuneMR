...
for (( i=1; i<=$num; i++ ))
do
awk -v i="$i" '{ if (NR != i) print $0}' $info > ${info}_${i}
plink --bfile ${plinkfile} --${plinktest} sex --pheno ${phenofile} --pheno-name ${pheno} --covar ${covarfile} --ci 0.95 --chr $chr --from-bp $startbp --to-bp $endbp --condition-list ${info}_${i} --out ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}
grep ADD ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest} > ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}.ADD
grep -v NA ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}.ADD > ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}.ADD.nNA
rm ${info}_${i}
rm ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}.ADD
rm ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}
rm ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.log
printf "CHR\tSNP\tBP\tA1\tTEST\tNMISS\tBETA\tSE\tLxy\tHxy\tSTAT\tP\n" > ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.txt_head
cat ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.txt_head ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}.ADD.nNA > ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.assoc.txt
rm ${dir}/${pheno}.${chr}.${startbp}.${endbp}.cond${i}.assoc.${plinktest}.ADD.nNA
rm ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.txt_head

cp ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.assoc.txt ${pr_dir}/${phenoold}_Tcells/1st/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.txt
cp ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.assoc.txt ${pr_dir}/${phenoold}_Neutrophils/1st/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.txt
cp ${dir}/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.assoc.txt ${pr_dir}/${phenoold}_Monocytes/1st/${phenoold}.${chr}.${startbp}.${endbp}.cond${i}.txt
